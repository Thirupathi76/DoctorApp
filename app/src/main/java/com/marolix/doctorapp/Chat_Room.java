...
import com.marolix.doctorapp.adapter.ChatRAdapter;
import com.marolix.doctorapp.bean.ChatBean;
...
public class Chat_Room extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        room_name = "Doctor Chat";//Utilities.getPreference(Chat_Room.this, Utilities.GROUP_NAME);
