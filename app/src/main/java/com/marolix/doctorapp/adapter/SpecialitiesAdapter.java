...
public class SpecialitiesAdapter extends RecyclerView.Adapter<SpecialitiesAdapter.ViewHolderClass> {
    Context context;
    String[] specialities;

    public SpecialitiesAdapter(Context context) {
        this.specialities = context.getResources().getStringArray(R.array.specialities_array);
